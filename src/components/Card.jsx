const Card = ({
  ...
  let symbol = "text-7xl text-center text-white-200"
  let line1 = "text-xl font-bold mt-10 border-b border-b-white-300"
  let line2 = "mt-4 mb-2 border-b border-b-white-300"
  ...
  let colorCards = function () {
    if (grupo === "Hidrogênio") {
      ...
      line2 = "mt-4 mb-2 border-b border-b-stone-300"
        ...
        symbol = "text-7xl text-center text-teal-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-teal-300"
        line2 = "mt-4 mb-2 border-b border-b-teal-300"
        ...
        symbol = "text-7xl text-center text-yellow-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-yellow-300"
        line2 = "mt-4 mb-2 border-b border-b-yellow-300"
        ...
        symbol = "text-7xl text-center text-orange-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-orange-300"
        line2 = "mt-4 mb-2 border-b border-b-orange-300"
        ...
        symbol = "text-7xl text-center text-purple-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-purple-300"
        line2 = "mt-4 mb-2 border-b border-b-purple-300"
        ...
        symbol = "text-7xl text-center text-fuchsia-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-fuchsia-300"
        line2 = "mt-4 mb-2 border-b border-b-fuchsia-300"
        ...
        symbol = "text-7xl text-center text-red-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-red-300"
        line2 = "mt-4 mb-2 border-b border-b-red-300"
        ...
        symbol = "text-7xl text-center text-blue-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-blue-300"
        line2 = "mt-4 mb-2 border-b border-b-blue-300"
        ...
        symbol = "text-7xl text-center text-emerald-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-emerald-300"
        line2 = "mt-4 mb-2 border-b border-b-emerald-300"
    } else if (grupo === "lantanídeos") {
        mainCard = "flex justify-around w-4/5 border rounded border-slate-600 bg-slate-600/80 m-auto mt-28 mb-40"
        symbolCard = "flex flex-col w-32 h-40 border justify-around rounded border-slate-400 p-2 mb-5"
        symbol = "text-7xl text-center text-slate-200"
        line1 = "text-xl font-bold mt-10 border-b border-b-slate-300"
        line2 = "mt-4 mb-2 border-b border-b-slate-300"
